    ...
    <div class="mt-5">
      ...
      <div class="mt-5 grid grid-cols-2 sm:grid-cols-3 md:grid-cols-3 lg:grid-cols-5 gap-4 bg-white dark:bg-gray-800 p-5 py-10 rounded-[20px]">        
        <div v-for="folderItem in foldersLists?.data" :key="folderItem" class="relative col-span-full sm:col-span-1 md:col-span-1 lg:col-span-1 xl:col-span-1 bg-white dark:bg-gray-700">
          <div class="flex justify-between border border-gray-100 p-5 rounded-lg items-center dark:border-none">
            <div class="flex items-center">
              ...
              <div class="ml-3 p-5">
                ...
                <p class="text-xs text-gray-400">Meetings: 20</p>
              </div>
            </div>
            <div  @mouseleave="folderItem.active = false">
              <i class="fas fa-ellipsis text-gray-300" @mouseover="folderItem.active = true"  ></i>
              <div v-if="folderItem.active" class="absolute z-10 bg-white divide-y divide-gray-100 rounded-lg shadow w-20 dark:bg-gray-700 dark:divide-gray-600">
                <ul class="py-1 text-sm text-gray-700 dark:text-gray-200">
                  <li>
                    <a class="text-gray-400 text-xs block px-2 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white"><i class="fas fa-pen text-gray-400 mr-2"></i>Edit</a>
                  </li>
                </ul>
              </div>
            </div>
