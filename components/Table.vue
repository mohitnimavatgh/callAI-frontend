<template>
  <div class="relative overflow-hidden py-2 sm:rounded-lg">
    ...
    <!-- Table -->
    <div :class="!filteredData?.length ? 'rounded-b-none rounded-lg' : ''"
      class="overflow-x-auto dark:border dark:border-gray-500 rounded-lg">
      <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
        ...
        <tbody>
          <tr v-if="filteredData && filteredData.length" v-for="(item, index) in filteredData" :key="index"
    ...
    <div v-if="!filteredData?.length" :class="!filteredData?.length ? 'rounded-t-none rounded-lg' : ''"
      class="py-12 dark:border dark:border-t-0 dark:border-gray-500">
